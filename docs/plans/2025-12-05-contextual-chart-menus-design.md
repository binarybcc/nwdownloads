...
4. **Layer 3b:** Subscriber table slide-out panel (distinct visual theme)
...
- **Production:** Synology NAS native (https://cdash.upstatetoday.com)
- **Stack:** PHP 8.2 (Apache) + MariaDB 10
...
4. **Deployment Guide:** NAS deployment steps
